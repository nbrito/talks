/* 
 * $Id: hello04.c,v 1.1 2010-06-16 07:08:51-03 nbrito Exp $
 */
 ...
 * ------------------x------------------x------------------x------------------
   ...
   ------------------x------------------x------------------x------------------ */
#ifndef HELLO04_C__
#define HELLO04_C__ 1

#include <common.h>

void loop(int rand_number_32_bit){
	rand_number_32_bit = 1 + (int) (4294967295.0 * rand() / (RAND_MAX + 1.0));
}

int main(int argc, char ** argv){
	int   c = NUMBER_OF_LOOPS;
	float seconds = 0;
	int   rand_number_32_bit = 0;
